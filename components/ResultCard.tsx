    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-cover bg-center bg-black font-sans w-full min-h-screen">
      <main className="flex flex-1 w-full items-center justify-center p-4">
        <div className="flex flex-col gap-6 items-center p-10 rounded-2xl shadow-2xl max-w-md w-full animate-in fade-in zoom-in-95 duration-1000 ease-out fill-mode-both">
          <h1
            className={`text-center font-press-start-2p font-extrabold tracking-tight drop-shadow-md ${
          ...
          <div className="flex flex-col items-center gap-4 mt-3">
            ...
            {subtitle && (
              <span
                className={`text-xs md:text-xl w-[100vw] text-center font-press-start-2p tracking-widest drop-shadow-md ${
          ...
          <div className="relative m-6 flex items-center justify-center">
            <div
              className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-32 w-[1000px] bg-gradient-to-r from-transparent to-transparent blur-2xl z-0 ${
      ...
      {showNote && (
        ...
        >
          <div
            ...
            className={`relative w-full max-w-md max-h-[80vh] flex flex-col rounded-2xl border-2 bg-linear-to-b from-[#151007] to-[#0b0d10] shadow-md animate-in zoom-in-95 fade-in duration-300 ${
          ...
          >
            ...
            >
              <h3
                className={`font-press-start-2p text-xs md:text-sm ${
            ...
            <div className="overflow-y-auto px-5 py-6">{noteContent}</div>
          </div>
        </div>
      )}
    </div>
